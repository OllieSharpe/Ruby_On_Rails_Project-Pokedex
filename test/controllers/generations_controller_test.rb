...
class GenerationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create generation" do
    assert_difference('Generation.count') do
      post generations_url, params: { generation: { games: @generation.games, region: @generation.region, user_id: @generation.user_id } }
    end
  ...
  test "should update generation" do
    patch generation_url(@generation), params: { generation: { games: @generation.games, region: @generation.region, user_id: @generation.user_id } }
